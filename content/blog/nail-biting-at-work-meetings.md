...
faq:
  - q: "How do I stop biting my nails during work meetings?"
    a: "Keep your hands occupied: hold a pen, take notes, press your fingertips together under the table. Identify whether meetings are a trigger due to boredom, anxiety, or passive listening, and address each specifically. Sitting on your hands works in a pinch but isn't sustainable."
  - q: "Is nail biting unprofessional?"
    a: "While nail biting is a common behavior affecting roughly 20-30% of adults, it can be distracting in professional settings. Colleagues may misinterpret it as anxiety, boredom, or lack of confidence. The good news is that workplace-specific strategies can keep it in check during the situations where it matters most."
  - q: "Why do I bite my nails more on video calls?"
    a: "Video calls combine several nail biting triggers: passive listening, limited physical movement, idle hands, and the mild anxiety of being on camera. Additionally, you may feel less observed because you're technically alone, making it easier for the behavior to slip through your self-monitoring."
  - q: "Can my employer say anything about my nail biting?"
    a: "Nail biting is generally considered a personal habit, not a workplace conduct issue. However, in client-facing roles or environments with hygiene requirements (food service, healthcare), it could be addressed. Most employers would not raise it directly, though colleagues might notice it."
  - q: "What's the fastest way to stop nail biting at your desk?"
    a: "Apply bitter nail polish before your workday — it intercepts biting attempts instantly. Combine it with keeping a fidget tool or stress ball at your desk for moments when your hands drift. For computer work specifically, an app like Nailed can detect hand-to-mouth gestures in real time and alert you before you realize you've started."
---
...
Desk work has one significant advantage over meetings: you're in front of a screen. This makes technology-based solutions viable. [Nailed](https://apps.apple.com/app/nailed-stop-biting-nails/id6761733224) runs in your Mac's menu bar and uses on-device ML to detect hand-to-mouth gestures through your camera. When it catches you reaching for your nails, a screen flash and beep interrupt the behavior before you've fully started. Since computer work is where much of the unconscious biting happens, having real-time detection running during your workday catches the episodes you'd otherwise miss entirely.
