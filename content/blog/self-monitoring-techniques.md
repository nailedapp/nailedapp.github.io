...
faq:
  - q: "Why does tracking a behavior change it?"
    a: "Tracking creates awareness of a behavior that's often automatic. Once aware, people naturally adjust. This is called reactivity — the act of observation changes the thing being observed. Additionally, tracking data provides feedback that reinforces change over time."
  - q: "How long should I track a behavior before expecting results?"
    a: "Research shows self-monitoring effects begin within the first 1-2 weeks. Consistent tracking for 4-8 weeks produces the most reliable behavior change. After that, many people can reduce tracking frequency while maintaining gains."
  - q: "What's the best way to track habits — paper or digital?"
    a: "Both work. Paper tracking has higher engagement in some studies due to the physical act of writing. Digital tracking offers automation, visualization, and long-term data storage. The best method is whichever one you'll actually use consistently."
  - q: "Can self-monitoring work for unconscious habits like nail biting?"
    a: "Traditional self-monitoring has limited effectiveness for unconscious behaviors because you can't log what you don't notice. Automated detection tools — like apps that use machine learning to identify the behavior in real time — fill this gap by creating awareness at the moment the behavior occurs."
---
...
Wearable devices track steps, heart rate, and sleep without manual input. Posture monitors detect slouching. Screen time tools track app usage automatically. And for body-focused repetitive behaviors, apps like [Nailed](https://apps.apple.com/app/nailed-stop-biting-nails/id6761733224) use on-device machine learning to detect nail biting through your Mac's camera, alerting you in real time and creating awareness at the exact moment the unconscious behavior occurs.
