...
keywords:
  ...
  - onychophagia
  - nail biting medical treatment
  - clinical nail biting
  - onychophagia cure
faq:
  - q: "Is onychophagia a mental disorder?"
    a: "Onychophagia is classified under 'Other Specified Obsessive-Compulsive and Related Disorder' in the DSM-5. It's not a standalone diagnosis but is recognized as a body-focused repetitive behavior (BFRB) that can significantly impair daily functioning and physical health when severe."
  - q: "Can a doctor prescribe medication for nail biting?"
    a: "Yes. Psychiatrists may prescribe N-acetylcysteine (NAC), SSRIs, or in some cases clomipramine for severe onychophagia that hasn't responded to behavioral treatment. Medication is typically used alongside therapy, not as a standalone treatment."
  - q: "What is the most effective treatment for onychophagia?"
    a: "Habit reversal training (HRT) has the strongest evidence base, with multiple randomized controlled trials showing significant reduction in nail biting. Combining HRT with other approaches — physical deterrents, environmental modification, or digital awareness tools — tends to produce the best outcomes."
  - q: "Should I see a therapist for nail biting?"
    a: "If nail biting is causing physical damage (bleeding, infections, dental problems), emotional distress, or you've been unable to stop on your own despite sustained effort, seeing a therapist — specifically one trained in HRT or CBT for BFRBs — is worth it. The TLC Foundation for BFRBs maintains a provider directory."
---
...
If you've tried to stop biting your nails and failed, you're not dealing with a willpower deficit. Onychophagia is a recognized [body-focused repetitive behavior (BFRB)](/blog/body-focused-repetitive-behaviors-guide/) with established treatment options ranging from behavioral therapy to pharmacological intervention. Here's what the research actually supports.
...
[HRT involves five core components](/blog/habit-reversal-training/):

1. **Awareness training** — Learning to recognize the behavior as it happens or just before
2. **Competing response training** — Substituting a physically incompatible behavior (e.g., clenching fists)
3. **Motivation enhancement** — Cataloging the negative consequences of biting
4. **Generalization training** — Practicing the techniques across different environments
5. **Relaxation training** — Reducing overall tension that fuels urges
...
CBT helps identify and restructure these thought patterns while building coping strategies for the emotional triggers ([anxiety](/blog/nail-biting-and-anxiety/), boredom, frustration) that drive biting episodes.
...
[Research and user experience suggest](/blog/bitter-nail-polish-vs-apps-vs-willpower/) these work well initially but have limitations: taste adaptation occurs in many users within 2-4 weeks, they require regular reapplication, and they don't address the underlying urge. They're useful as a short-term support tool while building other skills.
...
Desktop applications can use camera-based detection to identify hand-to-mouth gestures during computer use. [Nailed](https://nailedapp.io) is one such tool — a macOS menu bar app that uses on-device machine learning to detect nail biting gestures and delivers instant screen flash and audio alerts. All processing runs locally with no data collection, which is relevant given the camera-based detection method. This approach is particularly applicable for people whose biting primarily occurs at a computer.

The advantage of [real-time detection tools](/blog/real-time-alert-nail-biting/) over manual tracking is that they catch the behavior you don't notice — which, for many people, constitutes the majority of biting episodes.
...
- [Track your triggers](/blog/why-you-bite-your-nails/) for 1-2 weeks to identify patterns
...
- Comprehensive assessment for co-occurring conditions ([ADHD](/blog/nail-biting-and-adhd/), anxiety disorders, OCD)
...
- **Nail regrowth** — [nails can recover fully](/blog/grow-nails-back-after-biting/) with sustained reduction in biting

[Breaking the habit is a process](/blog/how-long-to-break-nail-biting-habit/), not an event. Most people who successfully manage onychophagia use a combination of approaches and expect periodic lapses as part of the long-term picture.
...
<details>
<summary><strong>Is onychophagia a mental disorder?</strong></summary>
Onychophagia is classified under "Other Specified Obsessive-Compulsive and Related Disorder" in the DSM-5. It's not a standalone diagnosis but is recognized as a body-focused repetitive behavior (BFRB) that can significantly impair daily functioning and physical health when severe.
</details>

<details>
<summary><strong>Can a doctor prescribe medication for nail biting?</strong></summary>
Yes. Psychiatrists may prescribe N-acetylcysteine (NAC), SSRIs, or in some cases clomipramine for severe onychophagia that hasn't responded to behavioral treatment. Medication is typically used alongside therapy, not as a standalone treatment.
</details>

<details>
<summary><strong>What is the most effective treatment for onychophagia?</strong></summary>
Habit reversal training (HRT) has the strongest evidence base, with multiple randomized controlled trials showing significant reduction in nail biting. Combining HRT with other approaches — physical deterrents, environmental modification, or digital awareness tools — tends to produce the best outcomes.
</details>

<details>
<summary><strong>Should I see a therapist for nail biting?</strong></summary>
If nail biting is causing physical damage (bleeding, infections, dental problems), emotional distress, or you've been unable to stop on your own despite sustained effort, seeing a therapist — specifically one trained in HRT or CBT for BFRBs — is worth it. The TLC Foundation for BFRBs maintains a provider directory.
</details>
