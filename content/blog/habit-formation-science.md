...
faq:
  - q: "Does it really take 21 days to form a habit?"
    a: "No. The 21-day myth comes from a misinterpretation of Dr. Maxwell Maltz's 1960 observations about plastic surgery patients adjusting to their appearance. Research from University College London found the actual average is 66 days, with a range of 18 to 254 days depending on the behavior and person."
  - q: "What's the difference between a habit and an addiction?"
    a: "Habits are automated behaviors triggered by context cues. Addictions involve neurochemical dependency, craving, tolerance, and withdrawal. A habit like putting on your seatbelt is automatic but doesn't involve craving. An addiction hijacks the dopamine system and creates compulsive behavior despite negative consequences."
  - q: "Can you break a bad habit permanently?"
    a: "You can't erase a habit — the neural pathway remains. But you can overwrite it with a new habit that uses the same cue and reward but a different routine. The old habit weakens with disuse through a process called synaptic pruning, though it may resurface under stress."
  - q: "Why do habits come back during stressful times?"
    a: "Stress shifts brain activity from the prefrontal cortex (deliberate decision-making) to the basal ganglia (automatic behavior). Under stress, the brain defaults to the strongest automated responses, which may include old habits you thought you'd broken. This is why stress management is critical for sustained behavior change."
---
...
1. **Identify the cue.** When does the habit happen? What precedes it?
2. **Identify the reward.** What craving does the habit satisfy?
3. **Find a replacement routine** that delivers the same reward through a different behavior.
4. **Practice the replacement** consistently in response to the same cue.
...
1. Habits form through repetition in consistent contexts, not through willpower or motivation
2. Average formation time is 66 days — plan accordingly
3. Stack new habits onto existing routines for reliable cues
4. Add immediate rewards to behaviors with delayed payoffs
5. Reduce friction for desired habits, increase friction for unwanted ones
6. You can't erase habits, only overwrite them with better alternatives
7. Stress management is part of habit change, not separate from it
8. Awareness comes before change — you can't modify what you can't see
