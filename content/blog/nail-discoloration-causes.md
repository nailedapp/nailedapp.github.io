...
keywords:
  ...
  - nail color change biting
  - yellow nails biting
faq:
  - q: "Why are my nails yellow after I stopped biting them?"
    a: "Yellow discoloration after biting can result from fungal infection (onychomycosis), staining from topical products like nail polish or bitter nail coatings, or thickened nail plate as recovery progresses. If the yellow color persists beyond the first 2-3 months of regrowth and isn't from a topical product, see a dermatologist to rule out fungal infection."
  - q: "Are white spots on bitten nails permanent?"
    a: "No. White spots (leukonychia) from biting trauma are caused by micro-damage to the nail matrix during formation. They grow out with the nail plate over 3-6 months and do not recur once the source of trauma is removed."
  - q: "When should I see a doctor about nail discoloration?"
    a: "See a dermatologist if you have dark brown or black streaks (which need melanoma evaluation), persistent green discoloration (bacterial infection), yellow-green thickening that spreads (fungal infection), or any discoloration that doesn't grow out over 6 months."
  - q: "Can nail polish hide discoloration during recovery?"
    a: "Yes, and it can also protect recovering nails. Use a base coat with strengthening properties, then apply color. Avoid dark colors without a base coat, as they can stain already-compromised nails. Give nails a polish-free week every 3-4 weeks to let the plate breathe and to monitor recovery progress."
---
