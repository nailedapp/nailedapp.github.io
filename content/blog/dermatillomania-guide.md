...
faq:
  - q: "What is dermatillomania?"
    a: "Dermatillomania, also called excoriation disorder or skin-picking disorder, is a body-focused repetitive behavior (BFRB) characterized by recurrent picking at one's own skin, leading to tissue damage. It is classified in the DSM-5 under obsessive-compulsive and related disorders."
  - q: "How common is skin-picking disorder?"
    a: "Skin-picking disorder affects roughly 1.4-5.4% of the general population. It is more commonly diagnosed in women, though this may partly reflect differences in help-seeking behavior rather than true prevalence differences."
  - q: "Is dermatillomania the same as picking at a pimple?"
    a: "Occasional skin picking is extremely common and not a disorder. Dermatillomania is diagnosed when picking is recurrent, causes tissue damage, leads to significant distress or functional impairment, and the person has made repeated unsuccessful attempts to stop."
  - q: "What treatments are available for dermatillomania?"
    a: "The strongest evidence supports habit reversal training (HRT) and the Comprehensive Behavioral Treatment model (ComB). Acceptance and commitment therapy (ACT) also shows promise. Medications like N-acetylcysteine and SSRIs are sometimes used as adjuncts."
  - q: "Where can I find help for skin-picking disorder?"
    a: "The TLC Foundation for BFRBs (bfrb.org) maintains a directory of specialized therapists. Look for clinicians trained in HRT or ComB specifically for BFRBs, not just general cognitive behavioral therapy."
---
...
Dermatillomania is part of the broader BFRB family. If you're interested in the connections between skin picking and related behaviors, the [body-focused repetitive behaviors guide](/blog/body-focused-repetitive-behaviors-guide/) covers the full spectrum, including how these conditions overlap and co-occur.