...
keywords:
  ...
  - stages of change
faq:
  - q: "Which behavior change model is most widely used?"
    a: "The Transtheoretical Model (Stages of Change) is the most recognized in clinical settings. The COM-B model is increasingly dominant in intervention design and public health. In commercial health tech, the Fogg Behavior Model is popular due to its simplicity."
  - q: "Can these models help with habits like nail biting?"
    a: "Yes. Nail biting and other body-focused repetitive behaviors respond well to model-based approaches. The Stages of Change model helps identify readiness, while habit reversal training (based on operant conditioning principles) provides the specific mechanism for change."
  - q: "What stage of change are most people stuck in?"
    a: "Most people are in the Contemplation stage — they know they want to change but haven't taken action. The gap between Contemplation and Preparation/Action is where most behavior change attempts stall, usually because people try to willpower through it rather than addressing capability and opportunity barriers."
  - q: "Do I need to know about behavior change models to change my behavior?"
    a: "No. These models are more useful for therapists, coaches, and intervention designers. But understanding which stage you're at can help you choose the right strategy — information-gathering techniques in early stages, practical tools and environment design in later stages."
---
...
The tiny version:
1. Requires almost no motivation (low barrier)
2. Is nearly impossible to fail (builds self-efficacy)
3. Gets you started (and often leads to doing more once started)
4. Builds the neural pathway for the habit
...
1. **Where am I?** (Stages of Change) → Identifies your readiness
2. **What's blocking me?** (COM-B) → Identifies the barrier
3. **How do I start?** (Fogg) → Make it tiny, attach to a prompt
4. **How do I reinforce it?** (Operant Conditioning) → Immediate positive feedback
5. **How do I sustain it?** (Self-Determination Theory) → Connect to autonomy, competence, relatedness
