...
keywords:
  ...
  - lip biting causes
faq:
  - q: "Is lip biting a body-focused repetitive behavior?"
    a: "Yes. Chronic, repetitive lip biting that causes tissue damage and is difficult to stop is classified as a BFRB (morsicatio labiorum). It falls under the same clinical umbrella as nail biting, hair pulling, and skin picking."
  - q: "Why do I keep biting my lips?"
    a: "Chronic lip biting is typically driven by anxiety, stress, boredom, or habit. The lips are highly sensitive, providing rich sensory feedback that can temporarily regulate emotions. Over time, the behavior becomes automatic and self-reinforcing—damaged lip tissue creates rough areas that invite further biting."
  - q: "Can lip biting cause permanent damage?"
    a: "Chronic lip biting can cause persistent dryness, cracking, scarring, infections, and mucosal changes. Most damage heals when the behavior stops, but long-term chronic biting can lead to permanent textural changes and, in rare cases, fibrosis."
  - q: "How do I stop biting my lips?"
    a: "Evidence-based approaches include habit reversal training (identifying triggers and substituting competing responses), keeping lips moisturized to reduce the rough texture that invites biting, stress management, and working with a therapist experienced in BFRBs for persistent cases."
  - q: "Is lip biting related to anxiety?"
    a: "Strongly. Anxiety is the most commonly reported trigger for chronic lip biting. The behavior provides temporary proprioceptive input and sensory stimulation that can briefly reduce anxiety. However, the resulting damage often increases anxiety, creating a cycle."
---
...
Understanding lip biting as part of the BFRB family—alongside nail biting, hair pulling, skin picking, and cheek biting—provides the right framework for effective treatment. For a broader view of how these conditions connect, see the [body-focused repetitive behaviors guide](/blog/body-focused-repetitive-behaviors-guide/).