...
faq:
  - q: "How common is it to have both hair pulling and nail biting?"
    a: "Quite common. Studies show 15-30% of people with trichotillomania also engage in chronic nail biting, and people with clinically significant nail biting have elevated rates of hair pulling. Having one BFRB significantly increases the risk of having another."
  - q: "Why do hair pulling and nail biting occur together?"
    a: "Both are body-focused repetitive behaviors driven by overlapping neurobiology—shared cortico-striatal circuitry, similar neurotransmitter involvement, and common emotional regulation functions. Genetic studies suggest shared heritability as well."
  - q: "Should both behaviors be treated at the same time?"
    a: "Usually yes. Research supports addressing multiple BFRBs simultaneously using a functional approach like the Comprehensive Behavioral Treatment model (ComB). Treating one while ignoring the other risks behavioral migration, where the untreated behavior increases."
  - q: "Can treating one BFRB make the other worse?"
    a: "Sometimes, temporarily. Behavioral migration—where reducing one BFRB leads to an increase in another—is documented in clinical literature. This is less likely when treatment addresses underlying functions (emotional regulation, sensory needs) rather than just suppressing the specific behavior."
  - q: "Are there therapists who specialize in multiple BFRBs?"
    a: "Yes. Clinicians trained in BFRB treatment through the TLC Foundation or similar programs are equipped to handle multiple co-occurring behaviors. Look for therapists listing HRT or ComB as specialties, and ask specifically about experience with multiple BFRBs."
---
...
Multiple BFRBs are a common reality, not a rare anomaly. Understanding them as expressions of a shared underlying pattern, rather than separate problems, is the foundation for effective treatment. The [BFRB guide](/blog/body-focused-repetitive-behaviors-guide/) provides broader context for this family of conditions.