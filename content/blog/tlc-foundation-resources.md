...
keywords:
  ...
  - TLC Foundation BFRBs
  - BFRB organization
  - hair pulling support
faq:
  - q: "What is the TLC Foundation for BFRBs?"
    a: "The TLC Foundation for Body-Focused Repetitive Behaviors is the leading nonprofit organization dedicated to BFRBs including trichotillomania, skin picking, and nail biting. Founded in 1991, they provide education, research funding, support groups, and clinical resources."
  - q: "How do I find a BFRB therapist through the TLC Foundation?"
    a: "Visit bfrb.org and use their therapist referral directory. You can filter by location, specialty (hair pulling, skin picking, nail biting), and whether they offer telehealth. Listed therapists have self-reported BFRB-specific training."
  - q: "What happens at the TLC Foundation conference?"
    a: "The annual conference features educational workshops, research presentations, support group sessions, expert panels, and community-building events. It's open to people with BFRBs, family members, therapists, and researchers. Many attendees describe it as transformative."
  - q: "Does the TLC Foundation offer free resources?"
    a: "Yes. The TLC Foundation provides free webinars, educational articles, a newsletter, and online support groups. Some programs like the conference and professional training courses have fees, though scholarships are available."
  - q: "Does the TLC Foundation fund research?"
    a: "Yes. The TLC Foundation funds research grants for BFRB studies, maintains a research registry to connect researchers with participants, and publishes summaries of BFRB research for public audiences."
---
...
1. **Education**: Public awareness and clinical training about BFRBs
2. **Research**: Funding studies and connecting researchers with participants
3. **Support**: Connecting people affected by BFRBs with each other and with qualified clinicians
...
1. **Visit bfrb.org**: Browse educational content about your specific BFRB
2. **Sign up for the newsletter**: Free, and it'll keep you informed about events and research
3. **Search the therapist directory**: Whether you're ready for treatment or just want to know your options
4. **Consider a support group**: Even one session can significantly reduce the isolation many people feel
5. **Look into the conference**: If you can attend, it's worth the investment. If not, watch for virtual programming and archived content
6. **Join the research registry**: Contributing to research helps the entire community
