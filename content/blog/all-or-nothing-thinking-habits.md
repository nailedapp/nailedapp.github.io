...
keywords:
  ...
  - slip vs relapse
  - perfectionism habit change
faq:
  - q: "What is all-or-nothing thinking in habit change?"
    a: "All-or-nothing thinking is the belief that any slip means total failure. In habit change, it sounds like 'I bit my nails so all my progress is gone' or 'I might as well give up since I already messed up.' It's a cognitive distortion that turns minor setbacks into complete collapses."
  - q: "What's the difference between a slip and a relapse?"
    a: "A slip is a single instance of the old behavior—biting your nails once after a period of not biting. A relapse is a return to the full, pre-change pattern of behavior. A slip is standing on one step; a relapse is falling down the whole staircase. Most slips only become relapses because of the emotional spiral that follows."
  - q: "How do I recover from a slip without spiraling?"
    a: "First, acknowledge it without drama: 'I bit my nails. That happened.' Then assess: what triggered it? Was it stress, boredom, distraction? Finally, resume your strategy immediately. Don't wait for Monday, don't restart your streak counter from zero, don't make it a bigger deal than it is. The faster you return to your plan, the less impact the slip has."
  - q: "Why does perfectionism make habit change harder?"
    a: "Perfectionism sets an impossible standard—zero slips, ever—and then uses any deviation as proof of failure. This creates constant anxiety about slipping, which ironically increases stress and makes slipping more likely. It also leads to the 'what the hell' effect, where one small slip triggers abandonment of the entire effort."
---
...
<details>
<summary>What is all-or-nothing thinking in habit change?</summary>
...
<details>
<summary>What's the difference between a slip and a relapse?</summary>
...
<details>
<summary>How do I recover from a slip without spiraling?</summary>
...
<details>
<summary>Why does perfectionism make habit change harder?</summary>
