...
faq:
  - q: "What is the best nail biting app in 2025?"
    a: "There's no single best app — it depends on your needs. For real-time detection at a Mac, Nailed is the top choice. For all-day wearable detection, HabitAware Keen2 leads the market. For habit tracking, apps like NailKeeper and Streaks work well. For multiple BFRBs, BFRB Buddy covers the most ground."
...
1. **Detection** (Nailed or Keen2) to interrupt the behavior in real time
2. **Tracking** (any habit tracker) to build awareness of patterns
3. **Behavioral technique** (Habit Reversal Training) to replace the behavior with a competing response
4. **Motivation** (NailKeeper or progress photos) to reinforce the change
