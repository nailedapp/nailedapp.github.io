...
faq:
  - q: "What is trichotillomania?"
    a: "Trichotillomania is a body-focused repetitive behavior (BFRB) characterized by recurrent, compulsive hair pulling that results in noticeable hair loss. It is classified as an obsessive-compulsive and related disorder in the DSM-5."
  - q: "How common is trichotillomania?"
    a: "Trichotillomania affects an estimated 1-2% of the general population, though some studies suggest rates as high as 3.5%. It occurs across all ages but most commonly begins between ages 10 and 13."
  - q: "What treatments work for trichotillomania?"
    a: "The most effective treatment is habit reversal training (HRT), a form of cognitive behavioral therapy. Other evidence-based options include the Comprehensive Behavioral Treatment model (ComB), acceptance and commitment therapy (ACT), and in some cases, medications like N-acetylcysteine or SSRIs."
  - q: "Is trichotillomania the same as OCD?"
    a: "No. While trichotillomania is classified alongside OCD in the DSM-5, it is a distinct condition. OCD involves intrusive thoughts and compulsions to reduce anxiety, while trichotillomania is driven more by sensory urges and emotional regulation. Treatment approaches also differ."
  - q: "Can trichotillomania be cured?"
    a: "There is no known permanent cure, but trichotillomania can be effectively managed. Many people achieve significant reduction in pulling through behavioral therapy, and some experience long periods of remission."
---
...
2. **Repeated attempts to decrease or stop** the pulling behavior
3. **Clinically significant distress** or impairment in social, occupational, or other important areas of functioning
4. The hair pulling is **not attributable to another medical condition** (such as a dermatological condition)
5. The hair pulling is **not better explained by symptoms of another mental disorder** (such as body dysmorphic disorder)
...
1. **Awareness training**: Learning to recognize pulling urges, triggers, and the physical movements that precede pulling
2. **Competing response training**: Substituting a physically incompatible behavior (like clenching fists or sitting on hands) when the urge arises
3. **Social support**: Enlisting a trusted person to provide encouragement and gentle reminders
...
Trichotillomania belongs to a family of body-focused repetitive behaviors. If this topic resonates, you may also want to learn about [the broader BFRB category](/blog/body-focused-repetitive-behaviors-guide/), which includes skin picking, nail biting, cheek biting, and other related conditions. Understanding the shared neurobiology across BFRBs helps explain why these behaviors so often co-occur.