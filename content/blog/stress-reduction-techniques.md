...
faq:
  - q: "What is the fastest way to reduce stress in the moment?"
    a: "Box breathing (inhale 4 seconds, hold 4, exhale 4, hold 4) activates your parasympathetic nervous system within 60-90 seconds. Pair it with progressive muscle relaxation for faster results."
  - q: "How long does it take for stress reduction techniques to show results?"
    a: "Acute techniques like breathing exercises work within minutes. Chronic stress reduction from regular exercise or meditation typically shows measurable cortisol changes within 2-4 weeks of consistent practice."
  - q: "Can stress cause physical habits like nail biting or skin picking?"
    a: "Yes. Stress is the number one trigger for body-focused repetitive behaviors (BFRBs) like nail biting, hair pulling, and skin picking. Reducing overall stress levels often decreases the frequency and intensity of these habits."
  - q: "Do stress reduction apps actually work?"
    a: "Research supports app-based interventions for stress. A 2023 meta-analysis in JMIR Mental Health found that digital stress management tools reduced perceived stress scores by a moderate effect size, especially when they included real-time feedback or tracking components."
---
...
1. **The autonomic nervous system** (breathing, heart rate variability)
2. **The musculoskeletal system** (muscle tension patterns)
3. **The cognitive system** (thought patterns and appraisals)
...
Awareness is step one, but human self-monitoring has limits. That's where technology helps. Apps that provide real-time feedback — whether for posture, breathing patterns, or stress-driven habits — create an external awareness loop that supplements your attention. For example, [Nailed](https://apps.apple.com/app/nailed-stop-biting-nails/id6761733224) uses on-device machine learning to detect nail biting and alerts you with a screen flash and sound, catching the exact moments when stress turns into a physical habit.
