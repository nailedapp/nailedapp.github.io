...
keywords:
  - BFRB vs OCD
  - body-focused vs obsessive compulsive
  - OCD spectrum disorders
faq:
  - q: "Are BFRBs a form of OCD?"
    a: "No. BFRBs and OCD are separate conditions, though they are related. The DSM-5 places BFRBs under Obsessive-Compulsive and Related Disorders alongside OCD, but they have distinct features. BFRBs lack the intrusive thoughts (obsessions) that define OCD."
  - q: "Can you have both a BFRB and OCD at the same time?"
    a: "Yes. Comorbidity between BFRBs and OCD is well documented. Studies suggest roughly 6–30% of people with a BFRB also meet criteria for OCD, depending on the specific behavior and study population."
  - q: "Do BFRBs respond to the same medications as OCD?"
    a: "Sometimes, but not reliably. SSRIs — the first-line medication for OCD — show inconsistent results for BFRBs. N-acetylcysteine (NAC) has shown more promise for some BFRBs, particularly hair pulling. Behavioral therapy tends to be more effective than medication for most BFRBs."
  - q: "Why does the distinction between BFRB and OCD matter?"
    a: "Treatment differs significantly. OCD treatment relies on Exposure and Response Prevention (ERP), while BFRBs respond better to Habit Reversal Training (HRT) and Comprehensive Behavioral Treatment (ComB). A misdiagnosis can lead to the wrong therapeutic approach."
---
