...
keywords:
  ...
  - hereditary nail biting
  - family history nail biting
  - nail biting genetics
faq:
  - q: "Is nail biting hereditary?"
    a: "Partially. Twin studies show that identical twins are significantly more likely to share the nail biting habit than fraternal twins, suggesting a genetic component. However, environment also plays a major role. The best estimate from current research is that genetics accounts for roughly 25-50% of the variation in nail biting behavior, with the rest attributable to environmental factors."
  - q: "If my parents bite their nails, will I?"
    a: "You have a higher probability, but it's not guaranteed. Family studies show nail biting runs in families, but shared genetics and shared environment are hard to separate. Having a parent who bites their nails approximately doubles your risk compared to someone without family history, but most children of nail biters don't develop the habit."
  - q: "Is there a specific gene for nail biting?"
    a: "No single 'nail biting gene' has been identified. The genetic influence likely involves multiple genes that affect temperament, impulsivity, stress reactivity, and grooming behavior. Genome-wide association studies on BFRBs have identified candidate regions, particularly genes involved in serotonin regulation, but no definitive nail biting gene exists."
  - q: "Can epigenetics change whether nail biting genes are expressed?"
    a: "Potentially. Epigenetic research shows that environmental factors like stress, nutrition, and early life experiences can modify how genes are expressed without changing the DNA sequence. A person might carry genetic predisposition for nail biting but never develop the behavior if environmental conditions don't activate those genes—or vice versa."
---
...
1. You inherited genetic predisposition
2. You learned the behavior by observation (modeling)
3. You share the same stressful environment
